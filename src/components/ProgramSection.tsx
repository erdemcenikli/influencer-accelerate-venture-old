      ...
      <div className="section-container">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold">
            How It Works: Your 6-Month Journey to ViralRise Stardom in Bali
          </h2>
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Our structured program kicks off in beautiful Bali, Indonesia, and is designed to transform your influence into a scalable business through three distinct phases.
          </p>
        </div>
        ...
        <div className="relative py-10">
          ...
          <div className="relative z-10 space-y-24">
            <TimelineItem
              title="Pre-Investment Phase in Bali"
              duration="Months 1-3"
              description="Experience the magic of Bali while we work closely with you to define your brand identity, refine your content strategy, and develop your business model - all at no cost to you. You'll receive intensive coaching, create content in stunning locations, and gain access to our network of industry experts."
            ...
            <TimelineItem
              ...
              duration="Month 3"
              description="At the end of month 3, our investment committee will decide whether to invest in your business. If selected, we'll invest $80,000 in your business and provide all the products you need to accelerate your growth. In exchange, we take a 10% equity stake in your influencer business."
              icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
